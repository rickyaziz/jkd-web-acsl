...
{{< tabs tabTotal="2" tabRightAlign="" >}}
{{% tab tabName="Example" %}}

<center>
    <img src="/images/babEight/b.1.PNG" alt="Gambar B.1 - STA Code" class="img-fluid mb-3 responsive-img">
    </center>
{{% /tab %}}
...
<center>
    <img src="/images/babEight/b.2.PNG" alt="Gambar B.2 - AP Code" class="img-fluid mb-3 responsive-img">
</center>
{{% /tab %}}
